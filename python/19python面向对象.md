...
#多重继承
class sample(student,speaker):#假如将student和speaker调换的话，则调用speak()函数会调用speaker的speak()函数
    a =''
    def __init__(self,n,a,w,g,t,n1):
        student.__init__(self,n,a,w,g)
        speaker.__init__(self,n1,t)
 
test = sample("Tim",25,80,4,"Python",'gouzi')
