...
1、稳定的排序算法：简单的理解就是，能保证排序前2个相等的数所在序列的前后相对位置顺序和排序后它们两个的前后位置顺序相同。如果A1 = A2，A1原来在位置前面，排序后A1还是保持在A2位置前。

2、不稳定的排序算法：排序前后在序列中的相对位置发生变化。

![img](https://images2015.cnblogs.com/blog/739525/201605/739525-20160503202729044-614991035.jpg)